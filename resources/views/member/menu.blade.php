                    ...
                    @if ($menu->konten->halaman->judul)
                        <div class="col-lg-6">
                            <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                                <h1 class="mb-3">{{ $menu->konten->halaman->judul }}</h1>
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="about-img position-relative overflow-hidden p-5 pe-0">
                            @if ($menu->konten->halaman->gambar != null)
                                <img class="img-fluid w-100"
                                    src="{{ $menu->konten->halaman ? $menu->konten->halaman->gambar() : 'no_image' }}">
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        @if ($menu->konten->halaman->teks)
                            <p class="mb-4">{!! $menu->konten->halaman->teks !!}</p>
                        @endif
                    </div>
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="about-img position-relative overflow-hidden p-5 pe-0">
                            @if ($menu->konten->artikel->gambar != null)
                                <img class="img-fluid w-100"
                                    src="{{ $menu->konten->artikel ? $menu->konten->artikel->gambar() : 'no_image' }}">
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">{{ $menu->konten->artikel->judul }}</h1>
                        <p class="mb-4">{!! $menu->konten->artikel->teks !!}</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="about-img position-relative overflow-hidden p-5 pe-0">
                            @if ($menu->konten->kegiatan->gambar != null)
                                <img class="img-fluid w-100"
                                    src="{{ $menu->konten->kegiatan ? $menu->konten->kegiatan->gambar() : 'no_image' }}">
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">{{ $menu->konten->kegiatan->judul }}</h1>
                        <p class="mb-4">{!! $menu->konten->kegiatan->teks !!}</p>
                    </div>
                </div>
            </div>
        </div>
