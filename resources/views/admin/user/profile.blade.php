                    ...
                    <form action="/admin/profile/{{ $pengguna->id }}/edit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file mb-3">
                                <input type="file" id="file" name="profile_pict"
                                    class="custom-file-input @error('profile_pict') is-invalid @enderror" accept="image/*"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/admin/akun/{{ $pengguna->user->id }}/edit" method="POST"
                        ...
                        <div class="form-group">
                            <label for="password_old" class="label">Password Sebelumnya</label>
