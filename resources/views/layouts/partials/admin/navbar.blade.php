...
$pengguna = Tb_pengguna::where('id_user', Auth::user()->id)->first();

?>

<div class="main-header">
    <!-- Logo Header -->
    <div class="logo-header" style="background: rgba(252, 145, 50);">
        ...
        <a href="/admin/dashboard" class="logo" style="margin-bottom: 12px; margin-left: 15px;">
            ...
            <h1 class="navbar-brand text-white mt-2">AYOGO</h2>
        </a>
    ...
    <!-- Navbar Header -->
    <nav class="navbar navbar-header navbar-expand-lg" style="background: rgba(255, 119, 31, 1);">
                ...
                <li class="nav-item dropdown hidden-caret">
                    <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                        <div class="avatar-sm float-right">
                            @if ( Auth::user()->id != 1  )
                                <img src="{{ $pengguna->gambar() }}" alt="Profile"
                                class="avatar-img rounded-circle">
                                
                            @else
                                <img src="{{ asset('assets/admin/img/profile.png') }}" alt="Profile"
                                class="avatar-img rounded-circle">
